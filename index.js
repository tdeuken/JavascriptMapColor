...
var url =
"https://api.forecast.io/forecast/9dd37c7edd01cb8a8d5b23f61a659c5e/" +state_info["%s", key].lat+"," +state_info["%s", key].lng;
...
if(currentTemp<= 10){
    $("#"+key).css('fill', "#0000FF");
}else if (currentTemp>= 11 && currentTemp<=30){
    $("#"+key).css('fill', "#00FFFF");
}else if (currentTemp>=31 && currentTemp <= 50){
    $("#"+key).css('fill', "#008000");

} else if (currentTemp>= 51 && currentTemp<=80){
    $("#"+key).css('fill', "#FFA500");
